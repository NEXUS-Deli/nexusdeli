import { J as jsxRuntimeExports, d as commonjsGlobal, w as getDefaultExportFromCjs, S as reactExports, R as React } from "./server-tfDrSU-s.js";
import { Z as Zap, d as Sidebar, T as Topbar, U as Users, M as Megaphone } from "./Topbar-CvlFCSIz.js";
import { d as createLucideIcon, h as motion, b as Smartphone, M as MessageCircle, F as Flame, c as TrendingUp } from "./router-CjJWtfgI.js";
import { a as Play, P as Pause } from "./play-eNNAgooA.js";
import { B as Bot } from "./bot-n8a1OuML.js";
import { Q as QrCode, W as Wifi } from "./wifi-DRULsPLq.js";
import { C as CircleCheck } from "./circle-check-DB1x9L1H.js";
import { D as DollarSign } from "./dollar-sign-DnQOJNEJ.js";
...
function KpiCard({ icon: Icon, label, value, delta, hint, tone = "primary", index = 0 }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-glow absolute inset-0 opacity-0 transition-opacity group-hover:opacity-100" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex items-start justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `h-10 w-10 grid place-items-center rounded-xl border ${toneMap[tone]}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "h-5 w-5" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 rounded-full border border-success/25 bg-success/10 px-2 py-0.5 text-[11px] font-semibold text-success", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mt-5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1 text-3xl font-bold tracking-tight", children: value }),
...
function shapeArea(x0, y0, y1) {
  ...
  function area(data2) {
    var i, j, k2, n = (data2 = array(data2)).length, d, defined0 = false, buffer, x0z = new Array(n), y0z = new Array(n);
    if (context == null) output = curve(buffer = path());
    for (i = 0; i <= n; ++i) {
      if (!(i < n && defined3(d = data2[i], i, data2)) === defined0) {
    ...
    value: (
      ...
      function renderIcon(data2) {
        ...
        if (/* @__PURE__ */ React.isValidElement(data2.legendIcon)) {
          var iconProps = _objectSpread$y({}, data2);
...
function getDomainOfDataByKey(data2, key, type, filterNil) {
  var flattenData = flatMap(data2, function(entry) {
...
function LabelList(_ref) {
  ...
  var data2 = restProps.data, dataKey = restProps.dataKey, clockWise = restProps.clockWise, id = restProps.id, textBreakAll = restProps.textBreakAll, others = _objectWithoutProperties$9(restProps, _excluded2$4);
...
var Bar = /* @__PURE__ */ (function(_PureComponent) {
  ...
  return _createClass$a(Bar2, [{
    ...
    value: function renderRectangles() {
      ...
      var prevData = this.state.prevData;
      if (isAnimationActive && data2 && data2.length && (!prevData || !isEqual(prevData, data2))) {
...
function RevenueChart() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border bg-gradient-surface p-5 shadow-card", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between mb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[11px] uppercase tracking-[0.18em] text-muted-foreground", children: "Faturamento recuperado" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1 text-2xl font-bold tracking-tight", children: "R$ 54.720" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-success font-medium", children: "+38% vs. semana anterior" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1 rounded-lg border border-border p-1 text-xs", children: ["7D", "30D", "90D"].map((t, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-[260px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AreaChart, { data, margin: { top: 8, right: 8, bottom: 0, left: -20 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("defs", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("linearGradient", { id: "gRec", x1: "0", y1: "0", x2: "0", y2: "1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "0%", stopColor: "oklch(0.62 0.234 27.5)", stopOpacity: 0.55 }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "100%", stopColor: "oklch(0.62 0.234 27.5)", stopOpacity: 0 })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("linearGradient", { id: "gOrg", x1: "0", y1: "0", x2: "0", y2: "1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "0%", stopColor: "oklch(0.76 0.18 152)", stopOpacity: 0.35 }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "100%", stopColor: "oklch(0.76 0.18 152)", stopOpacity: 0 })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CartesianGrid, { stroke: "oklch(1 0 0 / 0.05)", vertical: false }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(XAxis, { dataKey: "d", stroke: "oklch(0.65 0 0)", fontSize: 11, tickLine: false, axisLine: false }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(YAxis, { stroke: "oklch(0.65 0 0)", fontSize: 11, tickLine: false, axisLine: false, tickFormatter: (v) => `${v / 1e3}k` }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Area, { type: "monotone", dataKey: "organico", stroke: "oklch(0.76 0.18 152)", strokeWidth: 2, fill: "url(#gOrg)" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Area, { type: "monotone", dataKey: "recuperado", stroke: "oklch(0.62 0.234 27.5)", strokeWidth: 2.5, fill: "url(#gRec)" })
    ] }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 flex gap-5 text-xs", children: [
...
function Campaigns() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border bg-gradient-surface shadow-card overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-5 py-4 border-b border-border", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[11px] uppercase tracking-[0.18em] text-muted-foreground", children: "Máquina de recorrência" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-0.5 text-lg font-semibold", children: "Campanhas rodando" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "text-xs text-primary font-semibold hover:underline", children: "ver todas →" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "text-[11px] uppercase tracking-wider text-muted-foreground", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left font-medium px-5 py-3", children: "Campanha" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left font-medium py-3", children: "Status" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-right font-medium py-3", children: "Enviadas" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-right font-medium py-3", children: "Abertas" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-right font-medium py-3", children: "Converteu" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-right font-medium py-3 pr-5", children: "Faturado" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", {})
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: campaigns.map((c2, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.tr,
        {
          initial: { opacity: 0 },
          animate: { opacity: 1 },
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-5 py-3.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-medium", children: c2.name }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[11px] text-muted-foreground", children: "WhatsApp · IA Sofia" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: `inline-flex items-center gap-1.5 rounded-full border px-2 py-0.5 text-[11px] font-medium capitalize ${statusStyle[c2.status]}`, children: [
              c2.status === "rodando" && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "relative inline-flex h-1.5 w-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute inset-0 rounded-full bg-success pulse-dot text-success" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "relative inline-flex h-1.5 w-1.5 rounded-full bg-success" })
              ] }),
              c2.status
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "text-right text-muted-foreground", children: c2.sent.toLocaleString("pt-BR") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "text-right text-muted-foreground", children: c2.opened.toLocaleString("pt-BR") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "text-right font-semibold", children: c2.converted }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "text-right pr-5 font-semibold text-success", children: c2.revenue }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "pr-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-end gap-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "h-7 w-7 grid place-items-center rounded-md hover:bg-accent", children: c2.status === "pausada" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Play, { className: "h-3.5 w-3.5" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Pause, { className: "h-3.5 w-3.5" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "h-7 w-7 grid place-items-center rounded-md hover:bg-accent", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Ellipsis, { className: "h-3.5 w-3.5" }) })
            ] }) })
          ]
        },
        c2.name
...
function AgentsPanel() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border bg-gradient-surface p-5 shadow-card", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[11px] uppercase tracking-[0.18em] text-muted-foreground", children: "Funcionários digitais" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-0.5 text-lg font-semibold", children: "Agentes IA trabalhando" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Bot, { className: "h-5 w-5 text-primary" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: agents.map((a2, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `h-11 w-11 rounded-xl bg-gradient-to-br ${a2.color} grid place-items-center font-bold text-sm`, children: a2.name[0] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -bottom-0.5 -right-0.5 h-3 w-3 rounded-full bg-success border-2 border-background shadow-success-glow" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-sm", children: a2.name }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] px-1.5 py-0.5 rounded-md bg-success/15 text-success font-medium", children: "online" })
            ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-bold", children: a2.msgs.toLocaleString("pt-BR") }),
...
function WhatsappPanel() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border bg-gradient-surface p-5 shadow-card", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[11px] uppercase tracking-[0.18em] text-muted-foreground", children: "WhatsApp turbo" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-0.5 text-lg font-semibold", children: "Instâncias conectadas" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "inline-flex items-center gap-1.5 rounded-lg border border-success/30 bg-success/10 px-2.5 py-1.5 text-xs font-medium text-success hover:bg-success/15", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(QrCode, { className: "h-3.5 w-3.5" }),
        " Novo QR"
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2.5", children: instances.map((i) => {
      const online = i.status === "online";
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 rounded-xl border border-border bg-background/40 p-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `h-10 w-10 rounded-xl grid place-items-center ${online ? "bg-success/15 text-success" : "bg-destructive/15 text-destructive"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Smartphone, { className: "h-5 w-5" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-sm truncate", children: i.name }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: `inline-flex items-center gap-1 text-[10px] font-medium ${online ? "text-success" : "text-destructive"}`, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Wifi, { className: "h-3 w-3" }),
              " ",
              i.status
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[11px] text-muted-foreground font-mono", children: i.number })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-bold", children: i.queue }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-muted-foreground", children: "na fila" })
        ] })
      ] }, i.name);
    }) })
  ] });
...
const events = [
  { icon: CircleCheck, color: "text-success", text: "Campanha “Sexta da pizza” converteu", meta: "Cliente Pedro R. · R$ 84,50", time: "agora" },
  ...
  { icon: CircleCheck, color: "text-success", text: "Cliente reativado após 47 dias", meta: "Maria F. · pediu de novo", time: "8 min" }
];
function ActivityFeed() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border bg-gradient-surface p-5 shadow-card", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[11px] uppercase tracking-[0.18em] text-muted-foreground", children: "Tempo real" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-0.5 text-lg font-semibold", children: "Operação acontecendo" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "relative inline-flex h-2 w-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute inset-0 rounded-full bg-primary pulse-dot text-primary" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "relative inline-flex h-2 w-2 rounded-full bg-primary shadow-glow" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3.5", children: events.map((e, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `mt-0.5 h-7 w-7 rounded-lg bg-background/60 border border-border grid place-items-center ${e.color}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(e.icon, { className: "h-3.5 w-3.5" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-medium leading-tight", children: e.text }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[11px] text-muted-foreground", children: e.meta })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-muted-foreground whitespace-nowrap", children: e.time })
        ]
      },
      i
    )) })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0 flex flex-col", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1 px-5 lg:px-8 py-6 space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.section, { initial: {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-glow absolute inset-0" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "mt-3 text-2xl lg:text-3xl font-bold tracking-tight text-balance", children: [
                "Seu delivery está ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "vendendo agora" }),
                "."
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1.5 text-sm text-muted-foreground max-w-xl", children: "Clientes voltando automaticamente · WhatsApp trabalhando · IA respondendo · campanhas convertendo em tempo real." })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[11px] uppercase tracking-[0.18em] text-muted-foreground", children: "Hoje" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl font-bold", children: "R$ 8.420" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[11px] text-success font-medium", children: "+24% vs. ontem" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-12 w-px bg-border" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[11px] uppercase tracking-[0.18em] text-muted-foreground", children: "Recuperados" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl font-bold", children: "187" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[11px] text-success font-medium", children: "clientes hoje" })
              ] })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "grid grid-cols-2 lg:grid-cols-4 gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(KpiCard, { index: 0, icon: Repeat, label: "Pedidos recuperados", value: "1.284", delta: "+18%", hint: "últimos 7 dias", tone: "primary" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(KpiCard, { index: 1, icon: Users, label: "Clientes reativados", value: "612", delta: "+24%", hint: "que não voltavam há 30d+", tone: "success" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(KpiCard, { index: 2, icon: MessageCircle, label: "Mensagens enviadas", value: "42.8k", delta: "+12%", hint: "taxa de entrega 98.6%", tone: "primary" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(KpiCard, { index: 3, icon: TrendingUp, label: "Taxa de retorno", value: "38.4%", delta: "+9%", hint: "campanhas ativas", tone: "warning" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "grid grid-cols-1 xl:grid-cols-3 gap-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "xl:col-span-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(RevenueChart, {}) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(ActivityFeed, {})
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "grid grid-cols-2 lg:grid-cols-4 gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(KpiCard, { index: 0, icon: DollarSign, label: "Faturamento recuperado", value: "R$ 54.7k", delta: "+38%", hint: "semana atual", tone: "success" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(KpiCard, { index: 1, icon: Megaphone, label: "Campanhas ativas", value: "14", delta: "+3", hint: "3 em fila", tone: "primary" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(KpiCard, { index: 2, icon: Smartphone, label: "WhatsApps conectados", value: "3 / 3", delta: "100%", hint: "estabilidade 99.8%", tone: "success" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(KpiCard, { index: 3, icon: Bot, label: "IA respondendo", value: "2.786", delta: "+41%", hint: "contatos atendidos", tone: "warning" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Campaigns, {}),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "grid grid-cols-1 lg:grid-cols-2 gap-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(AgentsPanel, {}),
          /* @__PURE__ */ jsxRuntimeExports.jsx(WhatsappPanel, {})
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "pt-4 pb-2 text-center text-[11px] text-muted-foreground", children: [
          "Nexus",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary font-semibold", children: "Deli" }),
